...
const LowInventory = ({width}) => {
  ...
  return (
    <div style={{width: `${width}`, padding: "20px 5px", height:"300px"}}>
      <SeacrchFilter height='0px' title={"Low Inventory"} products={products.slice(0,5)} isProductLoading={isProductLoading} productsData={productsData} setProductsData={setProductsData} refetchProducts={refetchProducts}/>
    </div>
    );
};
